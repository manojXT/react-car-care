    ...
    <div className="new-appointment-container">
      ...
      <form onSubmit={handleSubmit} className="new-appointment-form">
        ...
        <div className="form-row toggle-buttons">
          <button
            type="button"
            className={formData.customerType === 'Individual' ? 'active' : ''}
          ...
          <button
            type="button"
            className={formData.customerType === 'Corporate' ? 'active' : ''}
        ...
        <div className="form-row">
          <label className="label-icon" htmlFor="registrationNo">
            <img src={Car} alt="Car Icon" className="icon" /> Registration No <span className="required">*</span>
          </label>
          <input
            type="text"
            id="registrationNo"
        ...
        <div className="form-row">
          <label className="label-icon" htmlFor="vehicle">
            <img src={Car} alt="Car Icon" className="icon" /> Vehicle <span className="required">*</span>
          </label>
          <input
            type="text"
            id="vehicle"
        ...
        <div className="form-row">
          <label className="label-icon" htmlFor="customerName">
            <img src={CustomerNameIcon} alt="Customer Icon" className="icon" /> Customer Name <span className="required">*</span>
          </label>
          <input
            type="text"
            id="customerName"
        ...
        <div className="form-row">
          <label className="label-icon" htmlFor="mobileNumber">
            <img src={MobileNumberIcon} alt="Mobile Icon" className="icon" /> Mobile Number <span className="required">*</span>
          </label>
          <input
            type="tel"
            id="mobileNumber"
        ...
        <div className="form-row">
          ...
          <input
            ...
            id="serviceAdvisor"
            name="serviceAdvisor"
            placeholder="Choose a service advisor"
