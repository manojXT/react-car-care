    ...
    <div className="mainContent">
      ...
      <div className="form">
        <div className="row">
          ...
          <input type="text" placeholder="Odometer In" />
          <input type="text" placeholder="Avg KMS / Day" />
          ...
          <div className="pickerWrapper">
            ...
            <input type="text" placeholder="Technician" className="technicianInput" />
          </div>
      </div>
      ...
      <div className="concernsSection">
        <textarea
          ...
          className="concernsTextarea"
        />
        <button className="addServiceButton" onClick={handleAddComplaint}>
          Add Service
        </button>
        ...
        <div className="complaintsContainer">
          {complaints.map((complaint, index) => (
            <button
              key={index}
              className={`complaintButton ${activeComplaints.includes(complaint) ? 'active' : ''}`}
      ...
      <div className="customerDetailsSection">
        <div className="detailsRow">
          <input type="text" placeholder="Select Corporate / Fleet" className="detailsInput" />
          <button className="addButton">+</button>
          <input type="text" placeholder="Customer Name *" className="detailsInput" />
          <button className="addButton">+</button>
          <input
            type="text"
            placeholder="Mobile Number (Preferably WhatsApp number) *"
            value={mobileNumber}
        ...
        <div className="detailsRow">
          <input
            ...
            className="detailsInput"
          />
          <input type="email" placeholder="Email ID" className="detailsInput" />
          <input
            type="date"
